...
class My_camera {
  private:
    ...
    String myScript = "https://script.google.com/macros/s/AKfycbxeSoZG0txsPzov1J7QrYUf60AoXhRSPmthiTolYrIj7CyiPDycv7aTVr1I7Sn1or8F/exec";    //Replace with your own url
    String myFilename = "filename=ESP32-CAM.jpg";
    String mimeType = "&mimetype=image/jpeg";
    String myImage = "&data="; //base64
